 ...
 * @author leona
 */
@WebServlet(name = "RealizarMatriculaTodos", urlPatterns = {"/RealizarMatriculaTodos"})
public class RealizarMatriculaTodos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Inscricao> lista = iDAO.listarRecebidasUE();
