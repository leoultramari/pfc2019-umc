 ...
 * @author leona
 */
@WebServlet(name = "ConsultarInscricao", urlPatterns = {"/ConsultarInscricao"})
public class ConsultarInscricao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Gson gson = new Gson();
            out.print(gson.toJson(iDAO.consultar(id)));
