...
public class AtualizarFuncionario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Funcionario objAtt = gson.fromJson(dadosEle, Funcionario.class);
            
            Funcionario obj = DAO.consultar(id);
            
            obj.setRegistro(objAtt.getRegistro());
            obj.setNome(objAtt.getNome());
            obj.setEmail(objAtt.getEmail());
            obj.setTelefone(objAtt.getTelefone());
            obj.setDataInicio(objAtt.getDataInicio());
            ...
            Auditoria.logInfo("Atualizou funcionário " + id);
